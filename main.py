...
def main():
  ...
  ankle_boots = {"Adrianna Papell": 7, "Aerosoles (burgundy)": 8, "Calvin Klein": 8, "Docle Vita (black)": 9, "Dresshead": 7, "Franco Sarto": 8, "Jones New York Chloe": 8, "Lulu Hun": 7, "Nine West": 7, "Old Navy": 7, "Royal Monk": 7, "Sam & Libby": 7}
  ...
  rings = {"Aislinn Byrne": 7, "blue zircon": 7, "Broadway": 7, "Celtic wedding ring": 7, "Claire's (red)": 7, "Claire's (turquoise)": 7, "Eton": 8, "Evil Eye": 7, "Forever 21 (kiss)": 7, "Forever 21 (pearl)": 7, "Forever 21 (pixelated)": 7, "Forever 21 (purple flower)": 7, "Forever 21 (red flower)": 7, "garnet": 7, "gold ring": 7, "green painted": 7, "jet/rhinestone wings": 8, "Pier1 (aqua)": 7, "Pier1 (black)": 7, "Pier1 (pink)": 7, "Pier1 (purple)": 7, "Pier1 (red)": 7, "rhinestone leaf": 7, "Teddy Thotz": 8, "The Market NYC": 7}
  ...
  sunglasses = {"A New Day (octagon)": 17, "A New Day (white)": 17, "Banana Republic (pink)": 17, "Banana Republic (white)": 17, "Foster Grant (brown)": 17, "Foster Grant -- Mireya": 17, "Foster Grant (pink)": 17, "Foster Grant (tortoiseshell)": 16, "Gardens by the Bay": 17, "GirlProps": 17, "Kiss": 16, "Locs (black)": 16, "Locs (light brown)": 23, "Locs (silver)": 17, "Malaysia": 17, "Miu Miu": 22, "Rainbow": 17, "Retro Pop (aqua)": 17, "Retro Pop (oxblood)": 16, "Retro Pop (pale blue)": 17, "Revlon": 17, "St. Mark's Place": 17, "steampunk": 17, "Target": 17, "Tod's": 17, "tortoiseshell": 16, "wayfarer": 17, "Zac Posen -- Anna": 16, "7-Eleven": 18}

  masks = {"Amazon (pink)": 7, "Amazon (tie-dye)": 6, "Amazon (white with butterflies": 5, "Amazon (white with flowers)": 6, "black lace": 11, "black sequined": 11, "Etsy": 13, "Fran Bloustein": 11, "Johnny Was (black)": 13, "Johnny Was (butterflies)": 12, "Johnny Was (gray)": 11, "Johnny Was (orchids)": 12, "Johnny Was (red)": 12, "Johnny Was (yellow)": 11, "poppies": 13, "rose gold": 11, "rose gold mesh": 5, "solid black": 12, "Some Bunny Loves You": 12, "Universal Thread (floral)": 14, "Universal Thread (pinstriped)": 14, "Universal Thread (plaid)": 12, "Wild Fable": 12}
  ...
  get_stats(evening_skirts, max_wears)

  print("Evening Jackets\n")
  get_stats(evening_jackets, max_wears)

  print("Evening Shoes\n")
  get_stats(evening_shoes, max_wears)

  print("Evening Accessories\n")
  get_stats(evening_accessories, max_wears)

  print("Evening Bags\n")
  get_stats(evening_bags, max_wears)
